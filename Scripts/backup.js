...
function selecaoPrato(A){
  ...
  if(i == 0){
    //SELECIONA QUANDO NÃO HÁ NADA SELECIONADO
    ...
    //TROCA A SELEÇÃO DE UM ITEM PARA OUTRO
    subtraiPrato(n);
...
function confirm(){
  ...
  //INSERE OS DADOS DOS ITENS SELECIONADOS NO POPUP DE CONFIRMAÇÃO
  ...
  //HABILITA O POPUP DE CONFIRMAÇÃO
